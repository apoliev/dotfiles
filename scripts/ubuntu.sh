...
(([ -f "$HOME/.zshrc" ] && mv $HOME/.zshrc $HOME/.zshrc.bak) || true) &&
(([ -f "$HOME/.tmux.conf" ] && mv $HOME/.tmux.conf $HOME/.tmux.conf.bak) || true) &&
(([ -f "$HOME/.vimrc" ] && mv $HOME/.vimrc $HOME/.vimrc.bak) || true) &&
(([ -f "$HOME/.irbrc" ] && mv $HOME/.irbrc $HOME/.irbrc.bak) || true) &&
stow -d $DIR/../ -t $HOME . &&
